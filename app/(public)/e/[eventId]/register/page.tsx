                ...
                <div className="max-w-6xl mx-auto">
                    <div className="rounded-3xl md:rounded-[3rem] border-2 border-primary/10 bg-linear-to-br from-white via-primary/5 to-white p-8 md:p-12 lg:p-20 shadow-lg relative overflow-hidden mb-12">
                        ...
                        <div className="relative z-10 text-center">
                            <h2 className="text-3xl md:text-5xl font-black text-primary-dark uppercase tracking-tighter leading-tight" style={{ color: event.branding.primaryColor || '#000' }}>Register Now</h2>
                            <p className="mt-4 text-gray-600">Secure your spot for {event.title}.</p>
                        </div>
                    </div>
